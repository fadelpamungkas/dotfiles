...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lsp"] = {
    after_files = { "/Users/fadel/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp/after/plugin/cmp_nvim_lsp.lua" },
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/fadel/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp",
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "vim-surround" },
  ...
  ["vim-surround"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/fadel/.local/share/nvim/site/pack/packer/opt/vim-surround",
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'nvim-cmp', 'Comment.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
