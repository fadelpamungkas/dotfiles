...
local on_attach = function(client, bufnr)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>cd", "<cmd>TroubleToggle lsp_definitions<cr>", opts)
	-- vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>ci', '<cmd>lua vim.lsp.buf.implementation()<cr>', opts)
	vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>ci", "<cmd>TroubleToggle lsp_implementations<cr>", opts)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>cr", "<cmd>TroubleToggle lsp_references<cr>", opts)
